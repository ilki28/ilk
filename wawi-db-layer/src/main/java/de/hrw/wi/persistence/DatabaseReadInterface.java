...
public interface DatabaseReadInterface {
	...
	/**
	 *
	 * @return Gibt eine Liste mit allen Kundendaten zurück
	 */
	
	public Set<String> getAllCustomer();
	
	/**
	 * @param ID Nr. des Kunden
	 * @return Gibt Telefonnummer des Kunden mit der jeweiligen ID zurück;
	 */
	...
	/**
	 * @param ID Nr. des Kunden
	 * @return Gibt Mailadresse des Kunden mit der jeweiligen ID zurück;
	 */
	...
	/**
	 * @param ID Nr. des Kunden
	 * @return Gibt Adresse des Kunden mit der jeweiligen ID zurück;
	 */
